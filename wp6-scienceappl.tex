\begin{workpackage}{Science applications}
  ...
  \begin{wpobjectives}
    ...
    \begin{enumerate}
      ...
      \item Science application B. Provide a brief motivation and expected results.
