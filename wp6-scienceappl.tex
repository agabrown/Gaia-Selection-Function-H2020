  ...
  \begin{wpobjectives}
    ...
    \begin{description}
      \item[Binary stars in Gaia] {
        ...
        \textsf{Aspects tested: overall Gaia selection function, specialized Gaia selection function: deliverables \ref{dev:wp3version1selfun}, \ref{dev:wp3version2selfun}, \ref{dev:wp4prototypev1}, \ref{dev:wp4prototypev2}.}
        }
    ...
    \item[The Luminosity Function of White Dwarfs]{
     ...
     \item[Mapping non-axisymmetric structures of the Milky Way via Cepheids]
        {
%        Our galaxy, the Milky Way, has long been known to possess non-axisymmetric features commonly seen in other disc galaxies, including a bar, spiral arms and a warp in the outer disc. Thanks to radio astronomy the spiral arms and warp were first seen in the gas, while only with the advent of all-sky near-infrared surveys have these structures become clearly evident in the stellar distribution of the Milky Way (Drimmel \& Spergel 2001; Drimmel 2000). For instance, while many studies have confirmed that the stellar distribution is warped, it is still unknown whether its orientation and amplitude coincides with that seen in the large-scale distribution of the gas, or even whether the warp geometry varies for different stellar populations (Reylé et al. 2009). Similar uncertainties exist for the spiral arms, where even the number of major spiral arms remains a matter of debate. Our knowledge is as limited as our view, and we find ourselves in the proverbial condition of being unable to see the forest for the trees. The difficulty of mapping these structures on a large scale is a consequence of our position within the disc, giving us an inside-out perspective, and a limited view due to interstellar extinction (e.g. Bland-Hawthorn \& Gerhard 2016). Furthermore, the unambiguous interpretation of the infrared data requires distance information, a quantity which was, until recently, necessarily deduced using indirect methods for stars beyond a few hundred parsecs. Consequently, our knowledge of the large-scale geometry of the Galaxy is much less certain than for other disc galaxies found many megaparsecs away. With data from the Gaia satellite, astronomers now have geometrically based distances out to several kiloparsecs, and the upcoming Gaia data release will contain stellar parameters that will allow an appropriate selection of subpopulations, including young populations that are traditional tracers of spiral arms. 
        ...
        Moreover, to understand the dynamical nature of the spiral arms and of the warp, mapping their geometry in configuration space is not sufficient. To understand why these structures exist and how they evolve, it is necessary to investigate their signature in velocity space. For this work our position in the Milky Way now becomes an advantage, as we are able to trace the bulk motions in the disc using the proper motions and line-of-sight velocities provided by Gaia for millions of stars, which has already provided indications of non-axisymmetric streaming motions in the giants \citep[see Fig.\ 5,][]{Katz2018a}, as well as the kinematic signature of the warp in the systematic vertical velocities of both young and old populations \cite{Poggio2018}. Furthermore, the warp precession has been measured for a sample of 12 million giants using a simple spatial and kinematic model of the Galaxy and taking into account a preliminary Gaia selection function and measurement errors \cite{Poggio2020}. 
...
%}
 ...
 %       {Gaia is also a time-domain survey, and variability-based identification of diagnostically precious classes of objects, such as classical Cepheids, are integral part of its science deliverables \citep{Gaia_Variability_2018}. In the Milky Way,Cepheids are the arguably ideal tracers to map the dynamics of the ``young'' disk (stars with ages $\tau_{age}<t_{dyn}\approx 150$~Myrs), and to map the pattern of how the large-scale star-formation pattern proceeded across the Galactic disk in the last $t_{dyn}$ \citep{Skowron2019}. This is because Cepheids combine three qualities: they are luminous (and can be seen to great distances, even in the presence of quite severe dust extinction), their distance can be ascertained quite precisely through the period-luminosity relation (even in light of marginal parallax information), and their period, also precisely predicts their mass and hence age.
        
%But of course, any such analysis revolves around 'what is the number density or Cepheids at distance X in direction Y at period/luminosity Z'; in short this requires both the selection function for Cepheids within Gaia; its modification when external surveys \citep[such as ASAS-SN][]{ASASSN2017} are included; and, as most classical Galactic Cepheids are at very low latitude, it requires combining the catalog selection function $S_C(y_s)$ with a 3D dust map \citep[eg.][]{3D-Dust-2018}
