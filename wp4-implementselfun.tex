\begin{workpackage}{Practical implementation and dissemination of the Gaia selection function}
  ...
  \begin{wpdescription}
    ...
    \wptask{MPIA}{All other}{7}{\duration}{Implementation of tools to include user selections}{
    ...
    \wptask{INAF}{All other}{7}{\duration}{Implementation of tools for combined selection functions}{
      ...
      Implement the selection functions for combinations of Gaia and other surveys based on the methodology developed in work package \ref{wp:selfuncombine}. This effort will focus on the combination of Gaia and the surveys mentioned in \ref{task:wp5examples}. In particular for the Galah survey an extended visit by the ULEI researcher to MONA is foreseen in order to profit from the spectroscopic survey expertise there.
    }
