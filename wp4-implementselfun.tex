\begin{workpackage}{Practical implementation and dissemination of the Gaia selection function}
  ...
  \begin{wpdeliverables}
    ...
    \wpdeliverable[20]{ULEI}{DEM}{PU}{Prototype V1 of open source and open data implementation of Gaia selection function.}\label{dev:wp4prototypev1}
    \wpdeliverable[31]{ULEI}{DEM}{PU}{Prototype V2 of open source and open data implementation of Gaia selection function.}\label{dev:wp4prototypev2}
    \wpdeliverable[\duration]{ULEI}{DEC}{PU}{Open source and open data implementation of Gaia selection function.}\label{dev:wp4final}
  \end{wpdeliverables}
