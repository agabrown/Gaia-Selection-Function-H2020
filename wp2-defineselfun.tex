\begin{workpackage}{Definition of the selection function}
  ...
  \begin{wpdescription}
    ...
    \wptask{MPIA}{MPIA}{1}{12}{Scientific coordination}{
      ...
      Scientific coordination of the work on defining the selection function and coordination of writing the paper corresponding to deliverable \ref{dev:wp2document}. This includes planning the work to be done, assigning sub-tasks and organizing the necessary meetings to discuss progress.
