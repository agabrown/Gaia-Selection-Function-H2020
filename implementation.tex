...
\begin{itemize}
    ...
    \item At ULEI $10\,000$ is reserved for support of the workshops and setting up a web portal. In addition $10\,000$ Euro is reserved for auditing costs.
\end{itemize}

For completeness the tables below contain the justifications per partner.
