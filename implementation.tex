...
\begin{itemize}
    ...
    \item Three community workshops will be organized which will be held in parallel to the plenary meeting. These meetings will be the occasion to train the community in the use of {\acro} tools and to have the users test the tools through using them.
    \item Each of the managers of WPs \ref{wp:selfungaia}--\ref{wp:scienceappl} will organize at least one face-to-face meeting during the lifetime of the project to discuss the progress of the work, plan the next steps, and create the occasion for internal testing of the tools.
...
\costsTravel{ULEI}{47250}{The travel costs are calculated as explained above which leads to \EUR~$33\,750$, to which \EUR~$13\,500$ is added for an extended (6 month) visit to the work with the partner at MONA.}
