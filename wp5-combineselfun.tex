\begin{workpackage}{Selection function for combinations of Gaia and other surveys}
  ...
  \begin{wpdescription}
    ...
    \wptask{MPIA}{All other}{7}{\duration}{Combined selection functions.}{
      ...
      For a few selected examples construct the selection function for the combination of Gaia and another survey, using the method developed in task~\ref{task:wp5method}. In this task the following surveys to which {\acro} members have ready access will be combined with Gaia: APOGEE, SDSS, Pan-Starss, GALAH, as well as SDSS-V and 4MOST. \memo{SDSS-V/4MOST combination based on target list of the surveys are not far enough along?}
    }    
