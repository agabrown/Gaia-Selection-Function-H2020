...
\begin{figure}[t]
    \centering
    \includegraphics{img/pgm_ideal_gsf.pdf}
    \caption{Caption}
    \label{fig:my_label}
\end{figure}

Although the Gaia survey selection function is seemingly very simple, with only a magnitude limit imposed on the observations (see \figref{fig:gsf_ideal}), each of the above components of the Gaia mission adds complexity to the survey selection function. A few examples are listed here:
\begin{itemize}
