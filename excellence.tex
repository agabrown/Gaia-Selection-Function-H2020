...
\begin{equation}
    \mathbb{P}(s | \varpi) = \frac{1}{Z} \mathbb{P}(\varpi | s, \sigma_\varpi) \mathbb{P}(s | l, b) \mathbb{P}(S | s, l, b)
\end{equation}
where $\mathbb{P}(s | l, b)$ refers to the 3D Milky Way map along the line of sight specified by Galactic longitude and latitude $(l,b)$, $\mathbb{P}(S | s, l, b)$ is the selection function and $Z$ is a normalisation constant. A detailed description of estimating unbiased distances from parallaxes is given in \citet{2018A&A...616A...9L}.
\\
