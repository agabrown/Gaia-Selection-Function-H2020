...
\begin{figure}
    ...
    \caption{The completeness of the sample of sources at $12<G\leq15$ for which parallax and proper motion are listed Gaia DR2 and high quality infrared photometry is listed in 2MASS. Note how combining these two catalogues leads to a drop in the completeness along the Galactic plane. This is due to crowding effects on the 2MASS catalogue. In addition in regions away from the Galactic plane artefacts related to the 2MASS sky survey are seen. This figure is an illustration of the selection function complexities that can arise when combing data from multiple catalogues.}
...
\begin{equation}
    \mathbb{P}(s | \varpi) = \frac{1}{Z} \mathbb{P}(\varpi | s, \sigma_\varpi) \mathbb{P}_\mathrm{map}(s | l,b) \mathbb{P}_\mathrm{obs}(s | l,b)
\end{equation}
where $\mathbb{P}_\mathrm{map}(s | l, b)$ refers to the 3D Milky Way map, $\mathbb{P}_\mathrm{obs}(s | l, b)$ is the selection function and $Z$ is a normalisation constant.
\\
