...
missions as measured by the publication rate of papers using its data in one form or another. Over 2000 papers appeared
...
first direct observational evidence of crystallization in the interiors of white dwarfs \cite{2019Natur.565..202T},
confirming a fifty year old prediction, and the uncovering of a major event 10 billion years into the Milky Way's past
...
The Gaia selection function is a highly non-trivial combination of on-board selection of sources to observed, telemetry
...
\begin{enumerate}
    \item Develop a detailed mathematical formulation of a survey selection function, where the goal is to keep this is
...
covering many topics including: fundamental stellar data across the Hertzsprung-Russell diagram, the characterisation of
...
\begin{itemize}
    \item What prominent Gaia science cases cannot (ever?) be done without a well-defined and computationally tractable
        ...
        \begin{itemize}
            ...
            \item Binary population parameters (frequency, parameter distributions)
