...
%% ========================================================
\title{Gaia Selection Function\\ \memo{(think of a more flashy title and acronym)} \\ \memo{(Completeness of the Gaia-verse, CoG?)}}
\shortname{GAIASELFUN} 
...
\coordinator{Anthony G.A.~Brown}{brown@strw.leidenuniv.nl}{Leiden University}
\participant{Leiden University}{LEID}{Netherlands} % First participant is the coordinator
\participant{Max-Planck-Institut f\"ur Astronomie}{MPIA}{Germany} % as example...
\participant{Osservatorio Astropfisico di Torino}{INAF}{Italy} % as example...
\participant{Oxford University}{UOXF}{United Kingdom}
