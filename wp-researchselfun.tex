\begin{workpackage}{Research and develop the Gaia selection function}
  ...
  \begin{wpdescription}
    ...
    \wptask{MPG}{All other}{7}{\duration}{R\&D spectroscopic selection functions}{
    ...
    \begin{description}
      ...
      \item[MPG] will lead Task~\ref{task:wp3toplevelGSF}.
  ...
  \begin{wpdeliverables}
    ...
    \wpdeliverable[12]{UCAM}{R}{PU}{Documentation of preliminary top level Gaia selection functions.}\label{dev:wp3version1selfun}
