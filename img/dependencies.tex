...
\begin{tikzpicture}[font=\scriptsize, thick, node distance=6.5cm]
  ...
  \begin{pgfonlayer}{background}
    \draw[draw=black!50!white, thick, rounded corners=5pt, fill=black!05!white] ($(wp3)-(1.5,2)$) rectangle
    ($(wp6)+(1.5,1.2)$);
    \node[yshift=0.0cm, text width=2cm, anchor=south] at ($(wp6)-(-0.3,2)$) {WP2\\ Mathematical framework};
  \end{pgfonlayer}
